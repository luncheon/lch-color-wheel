...
var e,h,i,s,a,n,o,r,l},e=t=>Math.round(256*(t>.0031308?1.055*t**(1/2.4)-.055:12.92*t)),h=t=>{return(t=>{const h=.01*t[0],i=.01*t[1],s=.01*t[2],a=-.9689*h+1.8758*i+.0415*s,n=.0557*h+-.204*i+1.057*s
...
let r=0
for(let e=0;e<n.height;e++){let a
for(let l=0;l<n.width;l++){const c=[100*(n.height-e)/n.height,l*this.maxChroma/n.width,t]
if(a){const t=h(c)
i(t)&&(a=t)}else a=s(c)
o.set(a,r),o[r+3]=255,r+=4}}a.putImageData(n,0,0)}_redrawLcHandle(){const t=this.lcSpaceElement,e=this.lcHandleElement.style,h=-this.handleDiameter/2
e.top=t.offsetTop+t.offsetHeight*(1-this._lch[0]/100)+h+"px",e.left=t.offsetLeft+t.offsetWidth*this._lch[1]/this.maxChroma+h+"px"}_requestRedrawLcSpace(){this._requestRedrawLcSpace_||(this._requestRedrawLcSpace_=!0,requestAnimationFrame(()=>{this._requestRedrawLcSpace_=!1,this._redrawLcSpace()}))}}return n.defaultOptions={wheelDiameter:200,wheelThickness:20,handleDiameter:16,maxChroma:134,onChange:Function.prototype},n}()
